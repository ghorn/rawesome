...
import qualified Carousel_sysid.Trajectory as PT
import qualified Carousel_sysid.Dae as PD
import qualified Carousel_sysid.DifferentialStates as PX
...
--    daeP = PD.parameters dae
    ...
    q'n'a = Quaternion (cos(0.5*delta)) $ V3 0 0 (sin(0.5*delta))

    q'a'b = quatOfDcm $ V3 (V3 e11 e12 e13)
                           (V3 e21 e22 e23)
                           (V3 e31 e32 e33)

    q'n'b = q'n'a * q'a'b

    rArm = V3 1.2 0 0 -- CS.rArm
...
main :: IO ()
main = runMultiCarousel "carousel trajectory" toState

...
data CarouselState = CarouselState{kiteXyz :: !Kite.Xyz, kiteDcm :: !Kite.Dcm, delta :: !P'.Double, ddelta :: !P'.Double,
                                   u1 :: !P'.Double, u2 :: !P'.Double, tc :: !P'.Double, wind_x :: !P'.Double}
...
instance P'.ReflectDescriptor CarouselState where
  getMessageInfo _
   = P'.GetMessageInfo (P'.fromDistinctAscList [10, 18, 25, 33, 41, 49, 57, 65])
      (P'.fromDistinctAscList [10, 18, 25, 33, 41, 49, 57, 65])

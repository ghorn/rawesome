...
data CarouselState = CarouselState{kiteXyz :: !Kite.Xyz, kiteDcm :: !Kite.Dcm, delta :: !P'.Double, rArm :: !P'.Double,
                                   zt :: !P'.Double, messages :: !(P'.Seq P'.Utf8), w0 :: !P'.Double}
    ...
    where
        update'Self wire'Tag old'Self
         = case wire'Tag of
             ...
             57 -> Prelude'.fmap (\ !new'Field -> old'Self{w0 = new'Field}) (P'.wireGet 1)
...
instance P'.ReflectDescriptor CarouselState where
  getMessageInfo _
   = P'.GetMessageInfo (P'.fromDistinctAscList [10, 18, 25, 33, 41, 57]) (P'.fromDistinctAscList [10, 18, 25, 33, 41, 50, 57])

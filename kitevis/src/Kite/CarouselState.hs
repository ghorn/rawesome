...
data CarouselState = CarouselState{kiteXyz :: !Kite.Xyz, kiteDcm :: !Kite.Dcm, delta :: !P'.Double, ddelta :: !P'.Double,
                                   u0 :: !P'.Double, u1 :: !P'.Double, tc :: !P'.Double}
    ...
    where
        update'Self wire'Tag old'Self
         = case wire'Tag of
             ...
             41 -> Prelude'.fmap (\ !new'Field -> old'Self{u0 = new'Field}) (P'.wireGet 1)
             49 -> Prelude'.fmap (\ !new'Field -> old'Self{u1 = new'Field}) (P'.wireGet 1)
...
instance P'.ReflectDescriptor CarouselState where
  getMessageInfo _
   = P'.GetMessageInfo (P'.fromDistinctAscList [10, 18, 25, 33, 41, 49, 57]) (P'.fromDistinctAscList [10, 18, 25, 33, 41, 49, 57])

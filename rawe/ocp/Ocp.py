...
class Ocp(object):
    ...
    def exportCode(self, cgOptions={}, acadoOptions=[], phase1Options={}, qpSolver='QP_OASES'):
        return exportOcp.exportOcp(self, cgOptions, acadoOptions, phase1Options, qpSolver)
